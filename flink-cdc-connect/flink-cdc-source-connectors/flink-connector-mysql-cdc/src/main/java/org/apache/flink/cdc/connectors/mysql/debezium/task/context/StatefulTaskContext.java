...
public class StatefulTaskContext {
    ...
    private boolean checkGtidSet(MySqlOffsetContext offset) {
        ...
        //            LOG.warn(
        //                    "Connector used GTIDs previously, but MySQL does not know of any GTIDs
        ...
        //
        //        // GTIDs are enabled
        //        LOG.info("Merging server GTID set {} with restored GTID set {}", availableGtidSet,
        // gtidStr);
        //
        //        // Based on the current server's GTID, the GTID in MySqlOffsetContext is adjusted
        // to ensure
        //        // the completeness of
        //        // the GTID. This is done to address the issue of being unable to recover from a
        // checkpoint
        //        // in certain startup
        //        // modes.
        //        GtidSet gtidSet = GtidUtils.fixRestoredGtidSet(availableGtidSet, new
        // GtidSet(gtidStr));
        //        LOG.info("Merged GTID set is {}", gtidSet);
        //
        //        if (gtidSet.isContainedWithin(availableGtidSet)) {
        //            LOG.info(
        //                    "MySQL current GTID set {} does contain the GTID set {} required by
        // the connector.",
        //                    availableGtidSet,
        //                    gtidSet);
        ...
        //            LOG.info(
        //                    "GTID set {} known by the server but not processed yet, for
        // replication are available only GTID set {}",
        //                    gtidSetToReplicate,
        //                    nonPurgedGtidSetToReplicate);
        //            if (!gtidSetToReplicate.equals(nonPurgedGtidSetToReplicate)) {
        //                LOG.warn("Some of the GTIDs needed to replicate have been already
        // purged");
        //                return false;
        //            }
        //            return true;
        //        }
        //        LOG.info("Connector last known GTIDs are {}, but MySQL has {}", gtidSet,
        // availableGtidSet);
        //        return false;
    }
